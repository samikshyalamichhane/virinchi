...
<button class="btn btn-sm btn-primary mb-2 float-right p-2" style="margin-top:10px"
    onclick="window.location='{{ route('events.create') }}'">Add
    Event</button>
@endcan
@endsection
@section('content')
                    ...
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        ...
                        @forelse ($newses as $key=>$detail)
                            <tr data-id="{{$detail->id}}">
                                ...
                                <td>
                                    <img src="{{Storage::url($detail->image)}}" height="100">
                                </td>
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('events.edit',['id'=>$detail->id]) }}`">Edit</button>
