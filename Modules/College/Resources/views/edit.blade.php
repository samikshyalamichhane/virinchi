                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="graduate_on_time" class="form-control" value="{{ $college->graduate_on_time }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="industry_readiness">INDUSTRY READINESS</label>
                                    <input name="industry_readiness" class="form-control" value="{{ $college->industry_readiness }}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="graduate_employed">GRADUATE EMPLOYED</label>
                                    <input name="graduate_employed" class="form-control" value="{{ $college->graduate_employed }}" required>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="education_model_description" class="form-control"
                                        required>{{ $college->education_model_description }}</textarea>
                                </div>
                            </div>
                        </div>
