...
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            @endif
            <form method="post" action="{{ route('college.update',$college->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Edit college</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <!-- <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="author" class="form-control" value="{{ $college->author }}" required>
                                </div>
                            </div> -->
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="description" class="form-control"
                                        required>{{ $college->description }}</textarea>
                                </div>
                            </div>
                            <!-- <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <textarea name="college_full_description" class="form-control"
                                        required>{{ $college->college_full_description }}</textarea>
                                </div>
                            </div> -->
                            <!-- <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="meta_title">Meta Title</label>
                                    <input name="meta_title" class="form-control" value="{{ $college->meta_title }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="meta_keyword">Meta Keyword</label>
                                    <input name="meta_keyword" class="form-control" value="{{ $college->meta_keyword }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="meta_description">Meta Description</label>
                                    <input name="meta_description" class="form-control" value="{{ $college->meta_description }}">
                                </div>
                            </div> -->
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-6 colxs-12">
                                        ...
                                        <div class="form-check checkbox">
                                            ...
                                            <img id="frame" src="{{ Storage::url($college->image) }}" width="100px"
                                                height="100px" />
                                        </div>
                                    </div>
                                    <!-- <div class="col-6 colxs-12">
                                        ...
                                        <div class="form-check checkbox">
                                            ...
                                            <img id="framecollegeBanner" src="{{ Storage::url($college->college_inner_banner) }}" width="100px"
                                                height="100px" />
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="col-3 colxs-12">
                                        <div class="form-check checkbox">
                                            <input class="form-check-input" id="publish" name="publish" type="checkbox"
                                                value="true" {{ $college->publish==1?'checked':'' }}>
