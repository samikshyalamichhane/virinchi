...
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('client.create') }}'">Add
    Client</button>
@endcan
@endsection
@section('content')
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i> Client</div>
                <div class="card-body">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <img src="{{Storage::url($client->icon)}}" height="100">
                                </td>
                                <td>
                                    {!! $client->publish?'<span
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('client.edit',['id'=>$client->id]) }}`">Edit</button>
                                    <button data-question="Are you sure to delete the data?" data-toggle="confirm" data-id="{{ $client->id }}" class="btn btn-xs btn-danger">Delete</button>
                                </td>
                            </tr>
                            @empty
                            <tr>
                        ...
                        <div class="team">
                            <div class="row">
                                ...
                                <div class="team-title col-sm-12">
                                    <img src="{{Storage::url($client->icon)}}" height="200" class="img-responsive">
                                </div>
                            </div>
                            <div class="details">
                                <div class="staus">
                                ...
                                <div class="action d-flex">
                                    <div class="p-3 edit"
                                        onclick="window.location=`{{ route('client.edit',['id'=>$client->id]) }}`">
                                        <i class="fas fa-edit"></i>
                                    </div>
                                    <div class="p-3 delete" data-toggle="confirm" data-id="{{ $client->id }}">
