    ...
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <form method="post" action="{{ route('slider.update',$slider->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Edit Slider</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="slider_title">Slider Title </label>
                                    <input name="slider_title" class="form-control" value="{{ $slider->slider_title }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="slider_title">Slider Link </label>
                                    <input name="link" type="url" class="form-control" value="{{ $slider->link }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-6 colxs-12">
                                        <div class="form-check checkbox">
                                            ...
                                            <img id="frame" src="{{ Storage::url($slider->image) }}" width="100px"
                                                height="100px" />
                                        </div>
                                    </div>
