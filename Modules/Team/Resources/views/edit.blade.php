                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="email" class="form-control" value="{{$team->email}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="contact">Contact</label>
                                    <input name="contact" class="form-control" value="{{$team->contact}}" required>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="location">Location</label>
                                    <input name="location" class="form-control" value="{{ $team->location }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="facebook">Facebook</label>
                                    <input name="facebook" class="form-control" value="{{ $team->facebook }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
