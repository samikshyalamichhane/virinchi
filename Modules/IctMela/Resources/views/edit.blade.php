...
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            @endif
            <form method="post" action="{{ route('ictmela.update',$ictmela->id) }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-6 colxs-12">
                                        ...
                                        <div class="form-check checkbox">
                                            ...
                                            <img id="frame" src="{{ Storage::url($ictmela->image) }}" width="100px" height="100px" />
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label for="image_description">Image Description</label>
                                            <input name="image_description" class="form-control" value="{{ $ictmela->image_description }}">
                                        </div>
                                    </div>
                                    {{--<div class="col-6 colxs-12">
                            ...
                            <div class="col-md-9 col-form-label">
                                <div class="row">
                                    <div class="col-3 colxs-12">
                                        <div class="form-check checkbox">
                                            <input class="form-check-input" id="publish" name="publish" type="checkbox" value="true"{{$ictmela->publish=1 ? 'checked' : ''}}>
