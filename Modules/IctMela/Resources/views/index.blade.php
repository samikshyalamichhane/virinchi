...
<ol class="m-0 border-0 breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('ictmela.index') }}">Ict Mela</a></li>

    {{-- <li class="breadcrumb-item active">Dashboard</li> --}}
</ol>
@can('Add Ictmela')
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('ictmela.create') }}'">Add
    IctMela</button>
@endcan
@endsection
@section('content')
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('ictmela.edit',['id'=>$blog->id]) }}`">Edit</button>
...
<script>
    $(function(){
        $('[data-toggle="confirm"]').jConfirm().on('confirm', function(e){
            var btn = $(this),
            id = btn.data('id');
            var url = '{{ route("ictmela.delete", ":id") }}';
