...
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            @endif
            <form method="post" action="{{ route('ictmela.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="resources" class="form-control"
                                        required>{{ old('resources') }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
                        ...
                        <div class="form-group row">
                            <div class="col-md-9 col-form-label">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="image_description" class="form-control" value="{{ old('image_description') }}" >
                                </div>
                            </div>
                                    {{--<div class="col-6 colxs-12">
