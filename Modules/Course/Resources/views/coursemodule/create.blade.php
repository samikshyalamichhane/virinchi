            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content" id="component-1-content">
                        <div class="tab-pane fade show {{(\Request::is('admin/course-modules/*/edit') || \Request::is('admin/course-modules/*/create')) ? '' : 'active'}}" id="component-1-1" role="tabpanel" aria-labelledby="component-1-1">
                            <form method="post" action="{{ route('courses.store') }}" enctype="multipart/form-data">
                                @csrf
                                <x-course-detail :course='$course' :coursecategories='$coursecategories'></x-course-detail>
                            </form>
                        </div>
                        <div class="tab-pane fade show {{(\Request::is('admin/course-modules/*/edit') || \Request::is('admin/course-modules/*/create')) ? 'active' : ''}}" id="component-1-2" role="tabpanel" aria-labelledby="component-1-1">
                        ...
                        <div class="tab-pane fade show {{(\Request::is('admin/course-attributes/*/edit') || \Request::is('admin/course-attributes/*/create')) ? 'active' : ''}}" id="component-1-3" role="tabpanel" aria-labelledby="component-1-3">
                        ...
                        <div class="tab-pane fade show" id="component-1-4" role="tabpanel" aria-labelledby="component-1-2">
                            <div>
                                <div class="white p-3">
