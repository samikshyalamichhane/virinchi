            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="tab-content" id="component-1-content">
                        <div class="tab-pane fade show {{(\Request::is('admin/course-modules/*/edit') || \Request::is('admin/course-attributes/*/edit')) ? '' : 'active'}} " id="component-1-1" role="tabpanel" aria-labelledby="component-1-1">
                            <form method="post" action="{{ route('courses.update',$course->id) }}" enctype="multipart/form-data">
                                @csrf
                                <x-course-detail :course='$course' :coursecategories='$coursecategories'></x-course-detail>
                            </form>
                        </div>
                        <div class="tab-pane fade show {{\Request::is('admin/course-modules/*/edit') ? 'active' : ''}}" id="component-1-2" role="tabpanel" aria-labelledby="component-1-1">
                            <form method="post" action="{{ route('coursemodules.update',[ $detail->id]) }}" enctype="multipart/form-data">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="form-group">
                                                ...
                                                <input name="title" class="form-control" value="{{$detail->title}}">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <br>
                                                <input id="publish" name="publish" type="checkbox" {{$detail->publish ? 'checked' : ''}}>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <table class="table table-responsive-sm table-bordered table-striped table-sm">
                                                    ...
                                                    <tbody>
                                                        @forelse ($course->courseModules as $key=>$courses)
                                                        <tr>
                                                            <td>{{ $key+1 }}</td>
                                                            <td>{{ $courses->title }}</td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <a href="{{ route('coursemodules.edit',['id'=>$course->id,'course_module_id'=>$courses->id])}}#component-1-2" class="btn btn-xs btn-primary">Edit </a>
                        ...
                        <div class="tab-pane fade show {{\Request::is('admin/course-attributes/*/edit') ? 'active' : ''}}" id="component-1-3" role="tabpanel" aria-labelledby="component-1-3">
                            <form method="post" action="{{ route('courseattributes.update',[ $detail->id]) }}" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="{{$course->id}}" name="course_id">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-sm-12">
                                            <div class="form-group">
                                                <label for="description">Description</label>
                                                <textarea name="attribute_description" class="form-control">{{$detail->attribute_description}}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                        ...
                        <div class="tab-pane fade show" id="component-1-3" role="tabpanel" aria-labelledby="component-1-2">
                            <div>
                                <div class="white p-3">
