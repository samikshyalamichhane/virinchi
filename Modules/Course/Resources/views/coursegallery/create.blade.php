...
<div>
    <div class="white p-3">
        <form id="myAwesomeDropzone" action="{{ route('projectgallery.store') }}" method="post" class="dropzone rounded" enctype="form-data/multipart">
            @csrf
            <div class="fallback">
            ...
            <input type="number" name="project_id" value="{{ $project->id }}" hidden="true">
...
<script>
    ...
    $(function() {
        ...
        var deleteUrl = "{{ route('projectgallery.delete', 'IMAGE_ID') }}";
        ...
        function loadImages() {
            $('#images-loading').show();
            $.ajax("{{ route('ajax.product-images.listing', $project) }}", {
                dataType: 'json',
