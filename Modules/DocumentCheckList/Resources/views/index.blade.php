...
<ol class="m-0 border-0 breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('document-check-list.index') }}">DocumentCheckList</a></li>

    {{-- <li class="breadcrumb-item active">Dashboard</li> --}}
</ol>
@can('Add DocumentCheckList')
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('document-check-list.create') }}'">Add
    DocumentCheckList</button>
@endcan
@endsection
@section('content')
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i> DocumentCheckList</div>
                <div class="card-body">
                    <table class="table table-responsive-sm table-bordered table-striped table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $detail->title }}</td>
                                <td>
                                    {{ Str::limit(html_entity_decode(strip_tags($detail->description)),100,'......') }}
                                </td>
                                ...
                                <td>
                                    ...
                                    onclick="window.location=`{{ route('document-check-list.edit',['id'=>$detail->id]) }}`">Edit</button>
...
<script>
    $(function(){
        $('[data-toggle="confirm"]').jConfirm().on('confirm', function(e){
            var btn = $(this),
            id = btn.data('id');
            var url = '{{ route("document-check-list.delete", ":id") }}';
