    ...
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <form method="post" action="{{ route('testimonial.store') }}" enctype="multipart/form-data">
                @csrf
                <div class="card">
                    <div class="card-header"><i class="fa fa-align-justify"></i> Add Testimonial</div>
                    <div class="card-body">
                        <div class="row">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input name="batch" class="form-control" value="{{ old('batch') }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="intake">Intake</label>
                                    <input name="intake" class="form-control" value="{{ old('intake') }}">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
