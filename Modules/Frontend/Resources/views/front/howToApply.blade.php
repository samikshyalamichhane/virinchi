                                 ...
                                 <div class="faq accordion">
                                    ...
                                    <div class="answer-wrapper">
                                       <div class="col-md-12 faqlist pt-4 qrpopup answer">
                                          ...
                                          <p>All applicants are required to submit an application fee to process the application form. The online application fee is NPR. 500.00 and can be paid via e-sewa QR code (<button type="button" class="btn btn-primary click" data-toggle="modal" data-target="#exampleModal">
  click here
                                        ...
                                        <p>
                                        No fee is charged to Virinchi College undergraduate students while enrolling in the Master of Business Administration program.
                                        </p>
                                        <p>
                                        Kindly send us the payment receipt in the following email:
                                        <a href="mailto:admissions@virinchicollege.edu.np"><b>admissions@virinchicollege.edu.np</b></a> or Whatsapp/Viber  at <b>9863253481</b></p>
                                        <p>
                                        After you complete the application  process you will be contacted from the office of admission for further procedure.
                                        </p>
                                    ...
                                    <div class="answer-wrapper">
                                       <ul class="answer-list">
                                          <div class="row mb-2 mt-3">
                                             <h6>Document Checklist For MBA</h6>
                                          </div>
                                          ...
                                          <li>Bachelor’s Transcript, Character, Provisional and Migration </li>
                                          <li>University Completion Certificate</li>
