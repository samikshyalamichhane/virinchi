               ...
               <div class="container">
                  <div class="row">
                     ...
                     <div class="col-md-12 d-md-none d-block mb-4">
                        <img src="{{asset('front/assets/img/scope.jpg')}}" alt="" class="img-fluid" />
                     </div>
                     <div class="scope-img">
                        <img src="{{asset('front/assets/img/scope.jpg')}}" alt="" class="img-fluid" />
                     </div>
                        ...
                        <figure class="gallery-image gallery-image--1x1 loaded" id="image1">
                           <a href="#image1">
                              <div class="gallery-image__crop" tabindex="-1">
                                 <img class="gallery-image__media lazyloaded" alt="ICT Mela 2.0" src="{{asset('front/assets/img/bict/bict-1.jpg')}}" />
                              </div>
