...
<main>
   ...
   <div class="tech-news-details">
      <div class="container">
         ...
         <iframe width="100%" height="500" src="https://www.youtube.com/embed/7AW97Or_Quk" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
         <div class="button-wrapper nbw yv">
                     <a class="btn primary-btn" href="https://youtu.be/7AW97Or_Quk">Subscribe Now</a>
                  </div>
