...
<ol class="m-0 border-0 breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="{{ route('contactus.productInquiry') }}">Product Inquiry</a></li>

    {{-- <li class="breadcrumb-item active">Dashboard</li> --}}
</ol>
{{-- @can('Add Contact')
<button class="float-right p-2 mb-2 btn btn-sm btn-primary" style="margin-top:10px"
    onclick="window.location='{{ route('contactus.productInquiry') }}'">Add
    Contact</button>
@endcan --}}
@endsection
@section('content')
<div class="container-fluid">
    <div class="fade-in">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header"><i class="fa fa-align-justify"></i> Product Inquiry</div>
                <div class="card-body">
